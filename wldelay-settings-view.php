...
class LDS_Settings_View {
    ...
    public function fail2ban_log_path_callback() {
        ...
        echo $this->tooltip( __( 'Log paths are restricted to the WordPress uploads directory by default. Leave empty to use the default uploads log file.', 'login-delay-shield' ) );
        printf(
